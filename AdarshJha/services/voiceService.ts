...
// export const startListening = (onSpeechResult, onError) => {
//   Voice.onSpeechResults = (e) => {
//     const spokenText = e.value?.[0] || '';
//     onSpeechResult(spokenText);
//   };

//   Voice.onSpeechError = (e) => onError(e.error?.message);
//   Voice.start('en-US');
// };

// export const stopListening = async () => await Voice.stop();
// export const destroyVoice = async () => await Voice.destroy();
